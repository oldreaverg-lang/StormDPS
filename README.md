...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20149123.svg)](https://doi.org/10.5281/zenodo.20149123)
[![License: CC BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by/4.0/)
[![Live](https://img.shields.io/badge/live-stormdps.com-6366f1)](https://stormdps.com)
...
See [CITATION.cff](CITATION.cff) for BibTeX/APA formats, and [dataset_README.md](dataset_README.md) for the full data dictionary.

## License

- **Code:** see repo license
- **Dataset & DPS scores:** [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) — free to use, adapt, and redistribute, including commercially, with attribution.
- **Upstream observational data** (NHC, JTWC, IBTrACS): public domain.

## Contact

Media inquiries, partnerships, or data licensing: **reavesrg@gmail.com**

Bugs, methodology corrections, dataset errata: [open an issue](https://github.com/oldreaverg-lang/StormDPS/issues).
