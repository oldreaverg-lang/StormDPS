...
def main() -> int:
    ...
    print("\n" + "=" * 64)
    print("If the SCORING FORMULA changed (not just ground truth/names), also")
    print("bump api/routes.py _DPS_CACHE_VERSION — the persistent /dps cache")
    print("serves old-code scores for previously-warmed live storms otherwise.")
    print("=" * 64)
